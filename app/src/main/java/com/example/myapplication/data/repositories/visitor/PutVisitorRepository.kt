...
class PutVisitorRepository(private val visiorService: VisitorService) {
    fun putVisitor(
        token : String ,
        name: String,
        nik: String,
        ...
        visiorService.putVisitor(token,ticketId, visitorRequest).enqueue(object : Callback<VisitorResponse> {
